...
function insertSticker(plan) {
  ...
  // НЕ устанавливаем growType для текста в flex layout
  ...
  if (titleText.layoutChild) {
    ...
    try {
      ...
      titleText.layoutChild.verticalSizing = 'auto'; // Auto height для текста
    } catch (e) {
  ...
  if (plan.text) {
    ...
    if (bodyText.layoutChild) {
      try {
        ...
        bodyText.layoutChild.verticalSizing = 'auto'; // Auto height для текста
      } catch (e) {
